...
/**
 * Thành phần (Component) đại diện cho màn hình chi tiết của một kế hoạch tập luyện cụ thể.
 *
 * @param {Props} props Các thuộc tính truyền vào từ navigation bao gồm route và navigation.
 * @returns {JSX.Element} Giao diện người dùng của màn hình chi tiết kế hoạch tập luyện.
 */
export const WorkoutDetailScreen: React.FC<Props> = ({ route, navigation }) => {
    ...
    useFocusEffect(
        useCallback(() => {
            async function loadData() {
                ...
                try {
                    const assignments = await getPatientAssignments(
                        uid,
                        "active",
                    );
                    ...
                    if (active) {
                        ...
                        if (active.doctorId) {
                            ...
                            setDoctorName(
                                doctor?.displayName || "Your therapist",
                            );
                        }
                        // Lấy buổi tập chưa hoàn thành
    ...
    if (!assignment) {
        return (
            <SafeAreaView style={[styles.safe, styles.center]}>
                <AppText variant="headlineMd" style={{ color: "#64748b" }}>
    ...
    const currentIndex = incompleteSession
        ? incompleteSession.currentExerciseIndex
        : 0;

    // Phân loại bài tập: bài tập còn lại lên trước, bài tập đã hoàn thành xuống dưới theo yêu cầu của người dùng.
    ...
    const renderExerciseCard = (
        ...
        const diffConfig = ex.difficulty
            ? DIFFICULTY_CONFIG[ex.difficulty]
            : null;
        ...
        <SafeAreaView style={styles.safe} edges={["top"]}>
            ...
            <View style={styles.topBar}>
                ...
                <AppText variant="headlineMd" style={styles.headerTitle}>
                    {t("workout.title", "Session Details")}
                </AppText>
                <View style={{ width: 40 }} />
            </View>
            ...
            >
                {/* Tóm tắt tổng quan nổi bật */}
                <View style={styles.heroSection}>
                    <View style={styles.heroBadgeRow}>
                        <Ionicons name="clipboard" size={16} color="#fff" />
                        <AppText variant="labelSm" style={styles.heroBadgeText}>
                            TARGET PLAN
                        </AppText>
                    </View>
                    <AppText variant="headlineLg" style={styles.heroTitle}>
                ...
                {/* Bài tập Đã hoàn thành ở dưới cùng (theo yêu cầu của người dùng) */}
            ...
            <View style={styles.footer}>
                ...
                <TouchableOpacity
                    style={[
                        styles.launchBtn,
                        currentIndex > 0 && styles.resumeBtn,
                    ]}
                    activeOpacity={0.85}
...
const styles = StyleSheet.create({
    ...
    footer: {
        ...
        backgroundColor: "rgba(248, 250, 253, 0.8)", // khớp với nền safe area nhưng trong suốt
    },
    launchBtn: {
        backgroundColor: "#2563eb", // Màu xanh lam động nổi bật
        flexDirection: "row",
        paddingVertical: 16,
        borderRadius: 20,
        alignItems: "center",
    ...
    resumeBtn: {
        backgroundColor: "#0f766e", // Màu mòng két thanh lịch phụ
        shadowColor: "#0f766e",
    },
