...
type AssignTemplateNavProp = NativeStackNavigationProp<
    DoctorStackParamList,
    "AssignTemplate"
>;
type AssignTemplateRouteProp = RouteProp<
    DoctorStackParamList,
    "AssignTemplate"
>;
...
export const AssignTemplateScreen: React.FC = () => {
    ...
    const [isTemplateSearchVisible, setIsTemplateSearchVisible] =
        useState(false);
    ...
    const loadData = async () => {
        ...
        setLoading(true);
        try {
            const [templatesData, assignmentsData, sessionsData] =
                await Promise.all([
            ...
            setPatientAssignments(
                assignmentsData.filter((a) => a.patientId === patientId),
            );
    ...
    const handleAssign = async () => {
        ...
        try {
            ...
            const generatedName = selectedTemplates
                .map((t) => t.name)
                .join(" + ");
            ...
            loadData();
            if (Platform.OS !== "web")
                Alert.alert("Success", "Session assigned successfully.");
        } catch (error) {
                                    ...
                                    >
                                                ...
                                                return (
                                                    <View
                                                        ...
                                                        style={[
                                                            ...
                                                            isCompleted &&
                                                                styles.assignmentBlockMonthCompleted,
                                                        ]}
                                                    >
                                                        <AppText
                                                            style={[
                                                                ...
                                                                isCompleted &&
                                                                    styles.assignmentBlockTextMonthCompleted,
                                                            ]}
                                                            numberOfLines={1}
                                                        >
                                                            {
                                        ...
                                        {assignmentsToday.length > 2 && (
                                            <AppText style={styles.moreText}>
                                                {t(
                                                    "doctor.assignTemplate.moreText",
                                                    {
                                                        count:
            ...
            >
                ...
                <View style={styles.timelineContainer}>
                    {hours.map((hour) => {
                        ...
                        const assignmentsInHour = assignmentsToday.filter(
                            (a) => {
                                const d = getAssignmentDate(a);
                                        ...
                                        return (
                                            <View
                                                ...
                                                style={[
                                                    ...
                                                    isCompleted &&
                                                        styles.assignmentBlockDayCompleted,
                                                ]}
                                            >
                                                <View
                                                    style={
                                                        styles.assignmentBlockHeaderDay
                                                    }
                                                >
                                                    <View
                                                        style={
                                                            styles.assignmentTitleWrapDay
                                                        }
                                                    >
                                                        <AppText
                                                            variant="labelMd"
                                                            style={[
                                                                ...
                                                                isCompleted &&
                                                                    styles.assignmentBlockTextDayCompleted,
                                                            ]}
                                                        >
                                                            {
                                                                assignment.templateName
                                                        ...
                                                        <AppText
                                                            ...
                                                            style={[
                                                                ...
                                                                isCompleted &&
                                                                    styles.assignmentBlockTimeDayCompleted,
                                                            ]}
                                                        >
                                                            {
                                                    ...
                                                    <View
                                                        style={[
                                                            ...
                                                            isCompleted &&
                                                                styles.assignmentStatusBadgeCompletedDay,
                                                        ]}
                                                    >
                                                        <Ionicons
                                                            name={
                                                        ...
                                                        <AppText
                                                            style={[
                                                                ...
                                                                isCompleted &&
                                                                    styles.assignmentStatusTextCompletedDay,
                                                            ]}
                                                        >
                                                            {isCompleted
                                                                ? t(
                                                                      "doctor.assignTemplate.completedBadge",
                                                                  )
                                                                : t(
                                                                      "doctor.assignTemplate.scheduledBadge",
                                                                  )}
                                                        </AppText>
                                                    </View>
                                                </View>
                                                ...
                                                {completedSession && (
                                                    ...
                                                    >
                                                        ...
                                                        <AppText
                                                            style={
                                                                styles.viewSessionButtonTextDay
                                                            }
                                                        >
                                                            {t(
                                                                "doctor.assignTemplate.viewSessionDetail",
                                                            )}
                                                        </AppText>
                                                    </TouchableOpacity>
                                                )}
            ...
            >
                <View style={styles.bottomSheetOverlay}>
                    <TouchableOpacity
                        ...
                        activeOpacity={1}
                        onPress={() =>
                            !assigning && setIsAddModalVisible(false)
                        }
                    />
                        ...
                        <View style={styles.bottomSheetHeader}>
                            ...
                            <View style={{ flex: 1 }}>
                                <AppText style={styles.bottomSheetTitle}>
                                    {t(
                                        "doctor.assignTemplate.createAssignmentTitle",
                                    )}
                                </AppText>
                                <AppText style={styles.bottomSheetSubtitle}>
                                    ...
                                    •{" "}
                                    {assignmentHour.toString().padStart(2, "0")}
                                    :00
                                </AppText>
                            </View>
                            <TouchableOpacity
                        ...
                        >
                            <View style={styles.titleInputContainer}>
                                <TextInput
                                    ...
                                    placeholder={t(
                                        "doctor.assignTemplate.addTitlePlaceholder",
                                    )}
                            ...
                            <View style={styles.inputGroup}>
                                ...
                                <View style={styles.inputBody}>
                                    <AppText style={styles.inputLabel}>
                                        {t(
                                            "doctor.assignTemplate.patientLabel",
                                        )}
                                    </AppText>
                            ...
                            <View style={styles.inputGroup}>
                                ...
                                <View style={styles.inputBody}>
                                    <AppText style={styles.inputLabel}>
                                        {t(
                                            "doctor.assignTemplate.templateLabel",
                                        )}
                                    </AppText>
                                    ...
                                    <View style={styles.templatesWrap}>
                                        {selectedTemplateIds.map((tid) => {
                                            ...
                                            return (
                                                <TouchableOpacity
                                                    key={tid}
                                                    style={
                                                        styles.selectedTemplateBox
                                                    }
                                                    onPress={() =>
                                                        setIsTemplateSearchVisible(
                                                            true,
                                                        )
                                                    }
                                                >
                                        ...
                                        <TouchableOpacity
                                            ...
                                            onPress={() =>
                                                setIsTemplateSearchVisible(true)
                                            }
                                        >
                                            <AppText
                                                style={
                                                    styles.selectTemplateBtnText
                                                }
                                            >
                                                {t(
                                                    "doctor.assignTemplate.addTemplateBtn",
                                                )}
                                            </AppText>
                                        </TouchableOpacity>
                                    </View>
                            ...
                            <View style={styles.inputGroup}>
                                ...
                                <View style={styles.inputBody}>
                                    <AppText style={styles.inputLabel}>
                                        {t(
                                            "doctor.assignTemplate.dateTimeLabel",
                                        )}
                                    </AppText>
                                    <AppText style={styles.inputValue}>
                                        {selectedDate.toLocaleDateString(
                                    ...
                                    <View style={styles.hourSelectorRow}>
                                        <AppText
                                            style={styles.hourSelectorLabel}
                                        >
                                            {t(
                                                "doctor.assignTemplate.hourLabel",
                                            )}
                                        </AppText>
                                        <ScrollView
                                            horizontal
            ...
            >
                <SafeAreaView style={styles.modalContainer}>
                    <View style={styles.searchModalHeader}>
                        <TouchableOpacity
                            onPress={() => setIsTemplateSearchVisible(false)}
                        >
                            <Ionicons
                                name="close"
                                size={28}
                        ...
                        <AppText style={styles.searchModalTitle}>
                            {t("doctor.assignTemplate.selectTemplateTitle")}
                        </AppText>
                        <TouchableOpacity
                            onPress={() => setIsTemplateSearchVisible(false)}
                        >
                    ...
                    <View style={styles.searchBarContainer}>
                        ...
                        <TextInput
                            ...
                            placeholder={t(
                                "doctor.assignTemplate.searchTemplates",
                            )}
                            placeholderTextColor={colors.outline}
                    ...
                    <ScrollView style={styles.searchResults}>
                        ...
                        {filteredTemplates.length === 0 && (
                            ...
                            >
                                ...
                                >
                                    {t("doctor.assignTemplate.noTemplates")}
                                </AppText>
                            </View>
                        )}
                    </ScrollView>
...
const styles = StyleSheet.create({
    ...
    inputIconPatient: { backgroundColor: "#eff6ff", borderColor: "#bfdbfe" },
    inputIconTemplate: { backgroundColor: "#ecfdf5", borderColor: "#a7f3d0" },
    inputIconTime: { backgroundColor: "#fff7ed", borderColor: "#fed7aa" },
    inputBody: { flex: 1 },
    inputLabel: {
        color: "#64748b",
        fontSize: 12,
