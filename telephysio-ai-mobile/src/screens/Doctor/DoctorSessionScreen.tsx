/**
 * DoctorSessionScreen — Doctor chat/feedback list with patients.
 */
...
export const DoctorSessionScreen: React.FC = () => {
        ...
        {loading ? (
          ...
          filtered.map((conv) => {
            ...
            const timeAgo = formatTimeAgo(
              timeDate?.toDate ? timeDate.toDate() : new Date(),
            );
            const unread = conv.unreadByDoctor || 0;
            const avatarLetter = conv.patientName
              ...
              >
                <View style={styles.convRow}>
                  ...
                  <View
                    style={[
                      styles.convAvatar,
                      unread > 0 ? { backgroundColor: colors.primary } : {},
                    ]}
                  >
                    <AppText
                      variant="labelMd"
                      style={{
                        color: unread > 0 ? "#fff" : "#64748b",
                        fontWeight: "700",
                      }}
                    >
                      {avatarLetter}
                  ...
                  <View style={styles.convContent}>
                    <View style={styles.convNameRow}>
                      <AppText
                        ...
                        style={[
                          styles.convName,
                          unread > 0 && { color: colors.onSurface },
                        ]}
                      >
                        {conv.patientName}
                      </AppText>
                  ...
                  {unread > 0 && (
                    <View style={styles.unreadBadge}>
                      <AppText variant="labelSm" style={styles.unreadText}>
                        {unread}
                      </AppText>
                    </View>
                  )}
