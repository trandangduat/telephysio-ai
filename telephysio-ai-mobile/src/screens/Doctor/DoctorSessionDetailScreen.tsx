/**
 * Màn hình DoctorSessionDetailScreen
 * 
 * Mục đích: Cho phép bác sĩ xem lại buổi tập của bệnh nhân.
 * Tính năng: Phát lại video, thống kê hiệu suất và gửi phản hồi.
 */
...
export const DoctorSessionDetailScreen: React.FC = () => {
    ...
    const handleSaveFeedback = async () => {
        if (!feedback.trim()) {
            Alert.alert(
                "Input Required",
                "Please enter feedback for the patient.",
            );
            return;
        }
                ...
                >
                            ...
                            <TouchableOpacity
                                ...
                                onPress={() =>
                                    setActiveVideo({
                                        ...
                                        name: t(
                                            "doctor.sessionDetail.sessionRecording",
                                        ),
                                    })
                                }
                            >
                    ...
                    <View style={styles.card}>
                        ...
                        {session.formBreakdown && (
                            <View style={styles.breakdown}>
                                {Object.entries(session.formBreakdown).map(
                                    ([key, val]) => (
                                        <View
                                            key={key}
                    ...
                    <View style={styles.card}>
                        ...
                        <TextInput
                            ...
                            multiline
                            placeholder={t(
                                "doctor.sessionDetail.feedbackPlaceholder",
                            )}
                        ...
                        >
                            {submitting ? (
                                ...
                                <>
                                    ...
                                    >
                                        {t(
                                            "doctor.sessionDetail.shareFeedback",
                                        )}
                                    </AppText>
                                </>
                            )}
