...
## 1. Sửa text FeedbackScreen: "AI" → "Bác sĩ"

**File:** `src/screens/Feedback/FeedbackScreen.tsx`
...
### Sửa:
- `src/screens/Feedback/FeedbackScreen.tsx` (text AI → doctor, title)
...
1. Sửa text FeedbackScreen (5 phút)
